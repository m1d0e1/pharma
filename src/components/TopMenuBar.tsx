...
const MENUS: Menu[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'link', label: 'الأرصدة الإفتتاحية', href: '/inventory/opening-balances', icon: Database,       roles: ['owner','admin'], permission: 'can_view_opening_balances' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'link', label: 'شجرة الحسابات',           href: '/finance/accounts',                icon: TreePine,   roles: ['owner','admin'], permission: 'acc_can_view_general' },
      { type: 'link', label: 'إعدادات ميزان المراجعة',  href: '/accounts/settings/trial-balance', icon: Settings,   roles: ['owner','admin'], permission: 'acc_can_view_general' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'link', label: 'إدارة الموظفين',   href: '/staff/manage', icon: UserCog,   roles: ['owner','admin'], permission: 'can_view_staff_manage' },
      { type: 'link', label: 'الوظائف والرواتب', href: '/staff/roles',  icon: Briefcase, roles: ['owner','admin'], permission: 'can_view_staff_roles' },
      { type: 'separator' },
      { type: 'link', label: 'سجل المراقبة',     href: '/audit',        icon: Shield,    roles: ['owner'], permission: 'can_view_audit' },
    ],
  },
  {
    ...
    items: [
      { type: 'link', label: 'الإعدادات', href: '/settings', icon: Settings, roles: ['owner','admin'], permission: 'can_view_settings' },
    ],
  },
  {
    ...
    items: [
      ...
      { type: 'separator' },
      { type: 'link', label: 'المصروفات',         href: '/expenses',              icon: Receipt,    roles: ['owner','admin'], permission: 'can_view_expenses' },
    ],
  },
  {
